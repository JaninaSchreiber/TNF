...
(string result) run_obj(string custom_parameters, int ga_iteration, int parameter_iteration, int num_replications, string executable, string default_xml)
{
    ...
    string cell_counts[];
    printf("custom param %s", custom_parameters);
...
// below
(void o) start (int ME_rank, int num_iterations, int num_variations, string strategy, string cooling_schedule,  string ga_parameters_file, string executable_model, string default_xml) {
    ...
    string algo_params = "%d,'%s','%s','%s'" %  (num_iterations, ga_parameters_file, strategy, cooling_schedule);
    EQPy_init_package(ME,"bas_box") =>
    EQPy_get(ME) =>
...
main() {
  ...
  string input_parameters_file = argv("ga_parameters");
  string strategy = argv("st");
  string cooling_schedule = argv("cs");
  ...
  start(rank, num_iterations, num_variations, strategy, cooling_schedule, input_parameters_file, executable, default_xml);
