...
CMD_LINE_ARGS="$* -ni=$ITERATIONS -nv=$REPLICATIONS  -exe=$EXECUTABLE_OUT -settings=$DEFAULT_XML_OUT/PhysiCell_settings.xml -ga_parameters=$GA_PARAMS_FILE_OUT"
